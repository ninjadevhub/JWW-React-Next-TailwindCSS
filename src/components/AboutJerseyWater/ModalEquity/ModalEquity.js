...
const ModalEquity = ({data, onClose}) => {
    ...
    return(
        <div className="flex flex-col" style={{height: '100%', zIndex: 10000, overflow: 'auto'}}>
            <div className='bg-brand-form-bg1 w-6/7 m-auto'>
                ...
                <div className='flex flex-col items-center justify-center mt-12 mb-12'>
                    <div>
                        <Image sourceUrl={data.modalIcon.sourceUrl} width='105' height='105' />
                    </div>
                    ...
                    <div className='flex justify-center w-2/3 m-auto mt-8'>
                        <div className='font-nova text-center text-xl text-brand-gray-typo'>{data.modalText}</div>
                    </div>
                </div>
