  ...
  return (
    <div className="rounded text-gray-700">
      <div className="py-4 pl-4 bg-gray-100">
        ...
        <div className="pt-3 text-center text-xs">{taxonomies?.committee?.[0]}</div>
      </div>
      <div className="pt-6 pb-4 px-8 bg-white">
        <div className="flex text-center text-xs">
          {taxonomies?.topic &&
          <div className="flex justify-center items-center py-2 px-3 mr-3 bg-gray-100">{taxonomies?.topic?.[0]}</div>}
          {taxonomies?.type &&
          <div className="flex justify-center items-center py-2 px-3 bg-gray-500 text-white">{taxonomies?.type?.[0]}</div>}
        </div>
