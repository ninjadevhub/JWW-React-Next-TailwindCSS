...
const AboutUsMegaMenu = forwardRef(
  ({ aboutUsMegaMenu }, ref) => (
    <div
      ...
      className="mega-menu latest-news-mega-menu absolute z-50 left-0 top-full hidden flex-wrap overflow-hidden px-6 pt-6 pb-36 -mt-2 md:-mx-2 lg:px-18 lg:-mx-6 bg-white bg-clip-padding"
      style={{
