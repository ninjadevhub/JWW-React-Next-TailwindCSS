...
const typesenseInstantsearchAdapter = new TypesenseInstantSearchAdapter({
  server: {
    apiKey: "kevink520Local", // Be sure to use the search-only-api-key
    nodes: [
      {
        host: "localhost",
        port: "8108",
  ...
  additionalSearchParameters: {
    queryBy: "post_title,content,taxonomies.committee,taxonomies.topic,taxonomies.jww_type"
  }
});
